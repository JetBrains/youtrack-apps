...
import { discoverWidgetEntries } from '../src/plugins/vite-plugin-youtrack-widget-entries.js';
import youtrackWidgetEntries from '../src/plugins/vite-plugin-youtrack-widget-entries.js';
