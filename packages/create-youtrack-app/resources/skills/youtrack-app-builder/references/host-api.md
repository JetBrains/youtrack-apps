...
| `requestParams` | `RequestParams` | Optional fetch parameters. For additional information, see [`requestParams`](#requestparams). | No |
...
| Parameter | Type | Description | Required |
| --- | --- | --- | --- |
| `relativeURL` | `String` | The relative URL to the custom HTTP endpoint. For more details, see HTTP Handlers. | Yes |
| `requestParams` | `RequestParams` | Optional fetch parameters. For details, see [`requestParams`](#requestparams). | No |
