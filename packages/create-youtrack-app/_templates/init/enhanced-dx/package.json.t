...
<% if (backendOnly === 'true') { -%>
    ...
    "build": "npm run clean && npm run build:backend && npm run lint && npm run copy:static && youtrack-app validate dist",
    "build:nolint": "npm run clean && npm run build:backend && npm run copy:static && youtrack-app validate dist",
...
<% } else { -%>
    ...
    "watch:backend": "vite -c vite.config.backend.ts build --watch --mode development",
    "watch:frontend": "vite build --watch --mode development",
    "watch:frontend:hmr": "DEV_MODE=true vite build --watch --mode development",
    "watch:coordinator": "youtrack-upload-coordinator --watch .build-state.json",
