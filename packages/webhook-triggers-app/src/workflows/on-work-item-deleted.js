...
exports.rule = {
  ...
  // Guard: use core.createGuard with custom check for removed work items
  guard: core.createGuard(EVENTS.WORK_ITEM_DELETED.key, function(ctx) {
    ...
    // Check if work items were removed
  ...
  // Action: collect removed work items and send webhooks
  action: function(ctx) {
